...
public class EntityRecognitionDemo {
    ...
    public static void main(String[] args) {
        ...
        // get the text to annotateSentence

        // load sentences
        String exampleSentences =
                "There will be a big announcement by Apple Inc today at 5:00pm."; //IOUtils.stringFromFile(props.getProperty("inputText"));
        ...
        for (CoreMap sentence : exampleSentencesAnnotation.get(CoreAnnotations.SentencesAnnotation.class)) {
            ...
            for (MatchedExpression me : matchedExpressions) {
                ...
                System.out.println("matched expression tokens:" + me.getAnnotation()
    ...
    public static class MyTokensAnnotation implements CoreAnnotation<List<? extends CoreMap>> {
        @Override public Class<List<? extends CoreMap>> getType() {
